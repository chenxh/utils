...
//        }
//
//        String result2 = py.translate("わたしわ阿飞, and my English name is Rex Lee. 网名是独孤影�?^_^。下面是�?��多音分词歧义测试，这个人无伤无臭味�?");
...
//
//        String[] result4 = py.translateInArrayNoMark("わたしわ阿飞, and my English name is Rex Lee. 网名是独孤影�?^_^。下面是�?��多音分词歧义测试，这个人无伤无臭味�?");
//        this.dumpStringArray(result4);

       
        String result5 = py.translate("わたしわ阿飞, and my English name is Rex Lee. 网名是独孤影,^_^。下面是多音分词歧义测试，这个人无伤无臭味");
